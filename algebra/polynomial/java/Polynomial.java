-/**	+double x,a,b, formula;
- * Contains classes which constructs a mathematical polynomial.	+	private static double polynomial(double x, double a, double b) {
- */	+		double formula = Math.pow(x, 2) - a * x + b;
-package mypolynomial;	+		return formula;
-	+	} 
